...
config = {
  ...
  "save_files":{
      "csv": "csv/single_patchtst/long_term/patchtst19.csv",
      "day": "figs/single_patchtst/long_term/everyday/graph19.jpg",
      "peak": "figs/single_patchtst/long_term/peakday/config19/"
  }
}