...
config = {
  ...
  "save_files":{
      "csv": "csv/single_patchtst/long_term/patchtst6.csv",
      "day": "figs/single_patchtst/everyday/graph6.jpg",
      "peak": "figs/single_patchtst/peakday/config6/"
  }
}