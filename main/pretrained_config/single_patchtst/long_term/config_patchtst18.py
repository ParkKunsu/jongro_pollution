...
config = {
  ...
  "save_files":{
      "csv": "csv/single_patchtst/long_term/patchtst18.csv",
      "day": "figs/single_patchtst/long_term/everyday/graph18.jpg",
      "peak": "figs/single_patchtst/long_term/peakday/config18/"
  }
}