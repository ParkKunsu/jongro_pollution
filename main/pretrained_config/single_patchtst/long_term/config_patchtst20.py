...
config = {
  ...
  "save_files":{
      "csv": "csv/single_patchtst/long_term/patchtst20.csv",
      "day": "figs/single_patchtst/long_term/everyday/graph20.jpg",
      "peak": "figs/single_patchtst/long_term/peakday/config20/"
  }
}