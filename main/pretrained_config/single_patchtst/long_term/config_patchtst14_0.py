...
config = {
  ...
  "save_files":{
      "csv": "csv/single_patchtst/long_term/patchtst14_0.csv",
      "day": "figs/single_patchtst/long_term/everyday/graph14_0.jpg",
      "peak": "figs/single_patchtst/long_term/peakday/config14/"
  }
}