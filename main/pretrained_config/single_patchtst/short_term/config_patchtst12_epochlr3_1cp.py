...
config = {
  ...
  "save_files":{
      "csv": "csv/single_patchtst/short_term/patchtst12_epochlr3_1cp.csv",
      "day": "figs/single_patchtst/short_term/everyday/graph12_epochlr3_1cp.jpg",
      "peak": "figs/single_patchtst/short_term/peakday/config12_epochllr3_1cp/"
  }
}