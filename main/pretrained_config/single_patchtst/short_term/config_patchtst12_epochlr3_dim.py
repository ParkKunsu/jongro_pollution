...
config = {
  ...
  "save_files":{
      "csv": "csv/single_patchtst/short_term/patchtst12_epochlr3_dim.csv",
      "day": "figs/single_patchtst/short_term/everyday/graph12_epochlr3_dim.jpg",
      "peak": "figs/single_patchtst/short_term/peakday/config12_epochllr3_dim/"
  }
}