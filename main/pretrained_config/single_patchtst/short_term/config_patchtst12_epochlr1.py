...
config = {
  ...
  "save_files":{
      "csv": "csv/single_patchtst/short_term/patchtst12_epochlr.csv",
      "day": "figs/single_patchtst/short_term/everyday/graph12_epochlr.jpg",
      "peak": "figs/single_patchtst/short_term/peakday/config12_epochlr/"
  }
}