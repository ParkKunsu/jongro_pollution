...
config = {
  ...
  "save_files":{
      "csv": "csv/single_patchtst/short_term/patchtst12_2.csv",
      "day": "figs/single_patchtst/short_term/everyday/graph12_2.jpg",
      "peak": "figs/single_patchtst/short_term/peakday/config12_2/"
  }
}